...
if (appProc) {
	...
	} else if (appBin) {if (!appBin->writeFile(newName)) {
...
int main() {
	// Set up information about the program to be instrumented
	 const char* progName = "helloWorld";
	 int progPID = 42;
	 const char* progArgv[] = {"helloWorld", " -h", NULL};
...
const char* interestingFuncName = "interestingFunction";
...
// Create and insert instrumentation snippet 2
 ...
 const char* progName2 = "IntereingProgram-rewritten";
